          ...
          <Card className="shadow-md">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select value={selectedCourse} onValueChange={setSelectedCourse} disabled={isActive}>
                ...
                {!selectedCourse && !isActive && <p className="text-sm text-destructive mt-1">Pilih kursus sebelum memulai timer</p>}
                {isActive && <p className="text-sm text-muted-foreground mt-1">Kursus terkunci saat timer berjalan</p>}
              </div>
